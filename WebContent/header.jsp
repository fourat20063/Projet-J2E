...
<%@ page import="com.irmelectro.service.impl.*, com.irmelectro.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #77AF9C; color: white; padding: 5px;">
		<h2>IRM Electronics</h2>
